...
Version  : 21.07.25
Release  : 18
URL      : file:///aot/build/clearlinux/packages/ninja/ninja-v21.07.25.tar.gz
Source0  : file:///aot/build/clearlinux/packages/ninja/ninja-v21.07.25.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627479531
mkdir -p clr-build
pushd clr-build
