...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629521007
mkdir -p clr-build
pushd clr-build
...
## pgo generate
export PGO_GEN="-fprofile-generate=/var/tmp/pgo -fprofile-dir=/var/tmp/pgo -fprofile-abs-path -fprofile-update=atomic -fprofile-arcs -ftest-coverage -fprofile-partial-training --coverage -lgcov"
