...
Version  : 1.10.1
Release  : 12
URL      : https://github.com/ninja-build/ninja/archive/v1.10.1/ninja-1.10.1.tar.gz
Source0  : https://github.com/ninja-build/ninja/archive/v1.10.1/ninja-1.10.1.tar.gz
...
%prep
%setup -q -n ninja-1.10.1
cd %{_builddir}/ninja-1.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597943677
...
cp %{_builddir}/ninja-1.10.1/COPYING %{buildroot}/usr/share/package-licenses/ninja/b7a11257fc8046a2f00f1a685da1f2bca2a3ba50
%make_install ||:
